const df_387_1 = new (require('@comunica/logger-void').LoggerVoid)();
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern_intercept__1_0_0_components_ActorRdfResolveQuadPatternIntercept_jsonld_ActorRdfResolveQuadPatternIntercept_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-resolve-quad-pattern-intercept/^1.0.0/components/ActorRdfResolveQuadPatternIntercept.jsonld#ActorRdfResolveQuadPatternIntercept_default_bus'
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rule_parse__1_0_0_components_ActorRuleParse_jsonld_ActorRuleParse_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rule-parse/^1.0.0/components/ActorRuleParse.jsonld#ActorRuleParse_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_dereference_rule__1_0_0_components_ActorDereferenceRule_jsonld_ActorDereferenceRule_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-dereference-rule/^1.0.0/components/ActorDereferenceRule.jsonld#ActorDereferenceRule_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rule_resolve__1_0_0_components_ActorRuleResolve_jsonld_ActorRuleResolve_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rule-resolve/^1.0.0/components/ActorRuleResolve.jsonld#ActorRuleResolve_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_rule__1_0_0_components_ActorOptimizeRule_jsonld_ActorOptimizeRule_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-optimize-rule/^1.0.0/components/ActorOptimizeRule.jsonld#ActorOptimizeRule_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_reason__1_0_0_components_ActorRdfReason_jsonld_ActorRdfReason_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-reason/^1.0.0/components/ActorRdfReason.jsonld#ActorRdfReason_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_quads_intercept__1_0_0_components_ActorRdfUpdateQuadsIntercept_jsonld_ActorRdfUpdateQuadsIntercept_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-update-quads-intercept/^1.0.0/components/ActorRdfUpdateQuadsIntercept.jsonld#ActorRdfUpdateQuadsIntercept_default_bus'
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_rule_resolve_hypermedia__1_0_0_components_ActorRuleResolveHypermedia_jsonld_IActorRuleResolveHypermediaArgs_default_invalidator = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-rule-resolve-hypermedia/^1.0.0/components/ActorRuleResolveHypermedia.jsonld#IActorRuleResolveHypermediaArgs_default_invalidator',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http_invalidate__2_0_0_components_ActorHttpInvalidate_jsonld_ActorHttpInvalidate_default_bus
});
...
const urn_comunica_default_rdf_resolve_quad_pattern_intercept_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern_intercept__1_0_0_components_ActorRdfResolveQuadPatternIntercept_jsonld_ActorRdfResolveQuadPatternIntercept_default_bus
});
...
const urn_comunica_default_rule_parse_actors_hylar = new (require('@comunica/actor-rule-parse-hylar').ActorRuleParseHylar)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rule_parse__1_0_0_components_ActorRuleParse_jsonld_ActorRuleParse_default_bus
});
...
const urn_comunica_default_dereference_rule_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_dereference_rule__1_0_0_components_ActorDereferenceRule_jsonld_ActorDereferenceRule_default_bus
});
const urn_comunica_default_rule_resolve_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rule_resolve__1_0_0_components_ActorRuleResolve_jsonld_ActorRuleResolve_default_bus
});
const urn_comunica_default_optimize_rule_mediators_main = new (require('@comunica/mediator-combine-pipeline').MediatorCombinePipeline)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_rule__1_0_0_components_ActorOptimizeRule_jsonld_ActorOptimizeRule_default_bus
});
const urn_comunica_default_rdf_reason_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_reason__1_0_0_components_ActorRdfReason_jsonld_ActorRdfReason_default_bus
});
...
const urn_comunica_default_rule_resolve_actors_hypermedia = new (require('@comunica/actor-rule-resolve-hypermedia').ActorRuleResolveHypermedia)({
  'cacheSize': 100,
  'httpInvalidator': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_rule_resolve_hypermedia__1_0_0_components_ActorRuleResolveHypermedia_jsonld_IActorRuleResolveHypermediaArgs_default_invalidator,
...
const urn_comunica_default_rdf_update_quads_intercept_actors_reasoned = new (require('@comunica/actor-rdf-update-quads-intercept-reasoned').ActorRdfUpdateQuadsInterceptReasoned)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_quads_intercept__1_0_0_components_ActorRdfUpdateQuadsIntercept_jsonld_ActorRdfUpdateQuadsIntercept_default_bus
});
