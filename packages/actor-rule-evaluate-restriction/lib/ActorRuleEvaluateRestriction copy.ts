...
import { AsyncIterator, single, UnionIterator, wrap } from '../../actor-rdf-reason-forward-chaining/lib/asynciterator';
...
export class ActorRuleEvaluateRestriction extends ActorRuleEvaluate {
  ...
  public async run(action: IActionRuleEvaluate): Promise<IActorRuleEvaluateOutput> {
    ...
    return { results: new UnionIterator(iterators, { autoStart: false }) as any };
  }
}
