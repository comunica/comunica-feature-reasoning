const df_359_0 = new (require('@comunica/logger-void').LoggerVoid)(undefined);
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_hypermedia_Bus_RdfUpdateHypermedia = new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_reason_Bus_RdfReason = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-reason/Bus/RdfReason'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern_intercept_Bus_RdfResolveQuadPatternIntercept = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-resolve-quad-pattern-intercept/Bus/RdfResolveQuadPatternIntercept'
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_rule_Bus_OptimizeRule = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-optimize-rule/Bus/OptimizeRule'
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_http_json_myHttpFetcher = new (require('@comunica/actor-http-node-fetch').ActorHttpNodeFetch)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_serializers_json_mediatorRdfSerializeMediatypes = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
...
const df_797_0 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_myRdfMetadataExtractPatchSparqlUpdate = new (require('@comunica/actor-rdf-metadata-extract-patch-sparql-update').ActorRdfMetadataExtractPatchSparqlUpdate)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_myRdfMetadataExtractAllowHttpMethods = new (require('@comunica/actor-rdf-metadata-extract-allow-http-methods').ActorRdfMetadataExtractAllowHttpMethods)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_myRdfMetadataExtractPutAccepted = new (require('@comunica/actor-rdf-metadata-extract-put-accepted').ActorRdfMetadataExtractPutAccepted)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_link_traversal__0_0_0_config_sets_extract_links_all_json_myRdfMetadataExtractTraverseQuadPatternQuery = new (require('@comunica/actor-rdf-metadata-extract-traverse-quad-pattern-query').ActorRdfMetadataExtractTraverseQuadPatternQuery)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-link-traversal/^0.0.0/config/sets/extract-links-all.json#myRdfMetadataExtractTraverseQuadPatternQuery',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract_Bus_RdfMetadataExtract
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_link_traversal__0_0_0_config_sets_extract_links_all_json_myRdfMetadataExtractTraverseAll = new (require('@comunica/actor-rdf-metadata-extract-traverse-all').ActorRdfMetadataExtractTraverseAll)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-link-traversal/^0.0.0/config/sets/extract-links-all.json#myRdfMetadataExtractTraverseAll',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract_Bus_RdfMetadataExtract
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_update_rdfjs_json_mediatorRdfUpdateHypermedia = new (require('@comunica/mediator-race').MediatorRace)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_quads_Actor_RdfUpdateQuads_Hypermedia_httpInvalidator_default = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_reasoning__1_0_0_config_sets_resolve_reasoned_json_mediatorRdfUpdateQuads = new (require('@comunica/mediator-race').MediatorRace)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-reasoning/^1.0.0/config/sets/resolve-reasoned.json#mediatorRdfUpdateQuads',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_quads_Bus_RdfUpdateQuads
});
...
const df_785_0 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': 'df_785_0',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
const df_785_1 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypeFormats',
  'name': 'df_785_1',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_link_traversal__0_0_0_config_sets_set_seeds_json_mySeedSetter = new (require('@comunica/actor-context-preprocess-set-seed-sources-quadpattern-iris').ActorContextPreprocessSetSeedSourcesQuadpatternIris)({
  'extractSubjects': true,
  'extractPredicates': false,
  'extractObjects': true,
  'extractGraphs': true,
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-link-traversal/^0.0.0/config/sets/set-seeds.json#mySeedSetter',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_context_preprocess_Bus_ContextPreprocess
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_link_traversal__0_0_0_config_sets_resolve_traverse_links_json_myHypermediaLinksTraverse = new (require('@comunica/actor-rdf-resolve-hypermedia-links-traverse').ActorRdfResolveHypermediaLinksTraverse)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-link-traversal/^0.0.0/config/sets/resolve-traverse-links.json#myHypermediaLinksTraverse',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links_Bus_RdfResolveHypermediaLinks
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_reasoning__1_0_0_config_sets_resolve_reasoned_json_mediatorRdfResolveQuadPattern = new (require('@comunica/mediator-race').MediatorRace)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-reasoning/^1.0.0/config/sets/resolve-reasoned.json#mediatorRdfResolveQuadPattern',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern_Bus_RdfResolveQuadPattern
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_reasoning__1_0_0_config_sets_resolve_reasoned_json_mediatorRdfReason = new (require('@comunica/mediator-race').MediatorRace)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-reasoning/^1.0.0/config/sets/resolve-reasoned.json#mediatorRdfReason',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_reason_Bus_RdfReason
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_queryoperators_json_mediatorResolveQuadPatternIntercept = new (require('@comunica/mediator-race').MediatorRace)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql/^1.0.0/config/sets/sparql-queryoperators.json#mediatorResolveQuadPatternIntercept',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern_intercept_Bus_RdfResolveQuadPatternIntercept
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_reasoning__1_0_0_config_sets_optimize_rule_json_myOptimizeRule = new (require('@comunica/mediator-combine-pipeline').MediatorCombinePipeline)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-reasoning/^1.0.0/config/sets/optimize-rule.json#myOptimizeRule',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_rule_Bus_OptimizeRule
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_reasoning__1_0_0_config_sets_optimize_rule_json_myOptimizeRuleRemoveFalseConclusion = new (require('@comunica/actor-optimize-rule-remove-false-conclusion').ActorOptimizeRuleRemoveFalseConclusion)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-reasoning/^1.0.0/config/sets/optimize-rule.json#myOptimizeRuleRemoveFalseConclusion',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_rule_Bus_OptimizeRule
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_reasoning__1_0_0_config_sets_optimize_rule_json_myOptimizeRulePatternRestriction = new (require('@comunica/actor-optimize-rule-pattern-restriction').ActorOptimizeRulePatternRestriction)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rule_dereference_json_mediatorRuleParseHandle = new (require('@comunica/mediator-race').MediatorRace)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql/^1.0.0/config/sets/rule-dereference.json#mediatorRuleParseHandle',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rule_parse_Bus_RuleParse
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_reasoners_json_myRuleParseHyLAR = new (require('@comunica/actor-rule-parse-hylar').ActorRuleParseHyLAR)({
  'mediaTypes': {},
  'mediaTypeFormats': {},
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_update_rdfjs_json_myRdfUpdateHypermediaPatchSparqlUpdate = new (require('@comunica/actor-rdf-update-hypermedia-patch-sparql-update').ActorRdfUpdateHypermediaPatchSparqlUpdate)({
  'mediatorHttp': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_http_json_mediatorHttp,
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_update_rdfjs_json_myRdfUpdateHypermediaSparql = new (require('@comunica/actor-rdf-update-hypermedia-sparql').ActorRdfUpdateHypermediaSparql)({
  'mediatorHttp': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_http_json_mediatorHttp,
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_reasoners_json_myRuleParseN3 = new (require('@comunica/actor-rule-parse-n3').ActorRuleParseN3)({
  'mediatorRdfParse': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_dereference_json_mediatorRdfParseHandle,
  'mediaTypes': {},
  'mediaTypeFormats': {},
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql/^1.0.0/config/sets/rdf-reasoners.json#myRuleParseN3',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rule_parse_Bus_RuleParse
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_update_rdfjs_json_myRdfUpdateHypermediaPutLdp = new (require('@comunica/actor-rdf-update-hypermedia-put-ldp').ActorRdfUpdateHypermediaPutLdp)({
  'mediatorHttp': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_http_json_mediatorHttp,
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_serializers_json_myRdfSparqlSerializer = new (require('@comunica/actor-sparql-serialize-rdf').ActorSparqlSerializeRdf)({
  ...
  'mediatorMediaTypeFormatCombiner': df_797_0,
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_update_rdfjs_json_myRdfUpdateQuadsHypermedia = new (require('@comunica/actor-rdf-update-quads-hypermedia').ActorRdfUpdateQuadsHypermedia)({
  'mediatorRdfDereference': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_mediatorRdfDereference,
  'mediatorMetadata': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_mediatorMetadata,
  'mediatorMetadataExtract': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_mediatorMetadataExtract,
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_reasoned_json_myRdfReasonedQuadPatternInterceptResolver = new (require('@comunica/actor-rdf-resolve-quad-pattern-intercept-reasoned').ActorRdfResolveQuadPatternInterceptReasoned)({
  'mediatorRdfReason': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_reasoning__1_0_0_config_sets_resolve_reasoned_json_mediatorRdfReason,
  'mediatorRdfResolveQuadPattern': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_queryoperators_json_mediatorResolveQuadPattern,
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql/^1.0.0/config/sets/resolve-reasoned.json#myRdfReasonedQuadPatternInterceptResolver',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern_intercept_Bus_RdfResolveQuadPatternIntercept
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_queryoperators_json_myQuadPatternQueryOperator = new (require('@comunica/actor-query-operation-quadpattern').ActorQueryOperationQuadpattern)({
  'mediatorResolveQuadPattern': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_queryoperators_json_mediatorResolveQuadPatternIntercept,
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_reasoners_json_myRdfReasonRuleRestriction = new (require('@comunica/actor-rdf-reason-rule-restriction').ActorRdfReasonRuleRestriction)({
  ...
  'mediatorOptimizeRule': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_reasoning__1_0_0_config_sets_optimize_rule_json_myOptimizeRule,
...
const urn_comunica_sparqlinit = new (require('@comunica/actor-init-sparql').ActorInitSparql)({
  ...
  'mediatorSparqlSerializeMediaTypeCombiner': df_785_0,
  'mediatorSparqlSerializeMediaTypeFormatCombiner': df_785_1,
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_reasoning_link_traversal__1_0_0_config_sets_sparql_queryoperators_json_myTraversalBgpQueryOperator = new (require('@comunica/actor-query-operation-bgp-traversal').ActorQueryOperationBgpTraversal)({
  'mediatorQueryOperation': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_queryoperators_json_mediatorQueryOperation,
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-reasoning-link-traversal/^1.0.0/config/sets/sparql-queryoperators.json#myTraversalBgpQueryOperator',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation_Bus_QueryOperation
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_queryoperators_json_myNopQueryOperator = new (require('@comunica/actor-query-operation-nop').ActorQueryOperationNop)({
  'mediatorQueryOperation': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_queryoperators_json_mediatorQueryOperation,
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_link_traversal__0_0_0_config_sets_link_queue_limit_json_myActorRdfResolveHypermediaLinksQueueWrapperLimitCount = new (require('@comunica/actor-rdf-resolve-hypermedia-links-queue-wrapper-limit-count').ActorRdfResolveHypermediaLinksQueueWrapperLimitCount)({
  'limit': 1000,
  'mediatorRdfResolveHypermediaLinksQueue': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_mediatorRdfResolveHypermediaLinksQueue,
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-link-traversal/^0.0.0/config/sets/link-queue-limit.json#myActorRdfResolveHypermediaLinksQueueWrapperLimitCount',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links_queue_Bus_RdfResolveHypermediaLinksQueue,
  'beforeActors': [
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rule_dereference_json_myRuleDereferencer = new (require('@comunica/actor-rule-dereference-http-parse').ActorRuleDereferenceHttpParse)({
  'mediatorHttp': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_http_json_mediatorHttp,
  'mediatorRuleParseMediatypes': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rule_dereference_json_mediatorRuleParseMediatypes,
  'mediatorRuleParseHandle': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rule_dereference_json_mediatorRuleParseHandle,
  'maxAcceptHeaderLength': 1024,
  'maxAcceptHeaderLengthBrowser': 128,
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql/^1.0.0/config/sets/rule-dereference.json#myRuleDereferencer',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rule_dereference_Bus_RuleDereference,
  'beforeActors': [
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rule_dereference_json_myRuleDereferencerFallback
]
});
const urn_comunica_my = ({
  ...
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_reasoned_json_myRdfReasonedQuadPatternInterceptResolver,
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_reasoners_json_myRdfReasonRuleRestriction,
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rule_dereference_json_myRuleDereferencer,
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rule_dereference_json_myRuleDereferencerFallback,
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_rdf_reasoners_json_myRuleParseHyLAR,
  ...
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_link_traversal__0_0_0_config_sets_set_seeds_json_mySeedSetter,
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_link_traversal__0_0_0_config_sets_extract_links_all_json_myRdfMetadataExtractTraverseQuadPatternQuery,
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_link_traversal__0_0_0_config_sets_extract_links_all_json_myRdfMetadataExtractTraverseAll,
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_link_traversal__0_0_0_config_sets_resolve_traverse_links_json_myHypermediaLinksTraverse,
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_link_traversal__0_0_0_config_sets_link_queue_limit_json_myActorRdfResolveHypermediaLinksQueueWrapperLimitCount,
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_reasoning_link_traversal__1_0_0_config_sets_sparql_queryoperators_json_myTraversalBgpQueryOperator,
